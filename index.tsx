  ...
  render() {
    return html`
      <div style="width: 100%; height: 100%;">
        ...
        <!-- Volumetric dynamic 3D background & AI body -->
        <gdm-live-audio-visuals-3d 
          .inputNode=${this.inputNode} 
          .outputNode=${this.outputNode} 
          .aiState=${this.aiState}
          @click-orb=${this.handleOrbClick}>
        </gdm-live-audio-visuals-3d>
        ...
        ${this.widgetData ? html`
          <div class="widget-overlay" @click=${(e: Event) => e.stopPropagation()}>
            ...
            <div class="widget-content">
              ...
              ` : ''}
              ${this.widgetData.widgetType === 'chart' || this.widgetData.widgetType === 'code' || this.widgetData.widgetType === 'text' ? html`
                <div class="widget-code" dir="auto">${this.widgetData.codeOrData || 'در حال آماده‌سازی اطلاعات...'}</div>
              ` : ''}
            </div>
          </div>
        ` : ''}
